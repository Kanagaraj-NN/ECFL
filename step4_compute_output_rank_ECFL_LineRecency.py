...
if __name__ == '__main__':
    ...
    input_directory = f"{WORKING_DIR}/output_{FEATURE}_{FL_TECHNIQUE}/step3_{FEATURE}_wt_{SINGLE_FEATURE}"
    ...
    output_directory = f"{WORKING_DIR}/output_{FEATURE}_{FL_TECHNIQUE}/step4_{FEATURE}_rank_{SINGLE_FEATURE}"
