...
if __name__ == '__main__':
    ...
    input_directory = "%s/fault-localization.cs.washington.edu/stmt_susp_%s" % (WORKING_DIR, FL_TECHNIQUE)
    ...
    output_directory = "%s/fault-localization.cs.washington.edu/line_suspiciousness_%s" % (WORKING_DIR, FL_TECHNIQUE)
    ...
    # print("\nSCRIPT NAME: stmt_to_line_suspiciousness.py")
